...
// Official marks (simple-icons paths): Claude's coral starburst, OpenAI's knot.
function ClaudeMark() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="#D97757" aria-hidden style={{ flex: "0 0 auto" }}>
...
function CodexMark() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="#0D0D0D" aria-hidden style={{ flex: "0 0 auto" }}>
